...
const OverviewCounter = () => {
  return (
    <section className=" container h-12 md:h-32 p-3">
      <div className=" grid grid-cols-4 divide-x divide-slate-700  mx-auto w-full md:max-w-[800px] shadow-lg bg-white -translate-y-10 md:-translate-y-20 p-2 my-4 md:p-8 dark:bg-gray-800 dark:text-white/70 ">
